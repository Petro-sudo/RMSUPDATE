  ...
  function srcAppServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ServiceService(http) {
        ...
        this.http = http;
        this.addProp = [];
        this.login_url = 'http://168.172.185.101:5000/login';
        this.reg_url = 'http://168.172.185.106:5000/lord';
        this.regstu_url = 'http://168.172.185.106:5000/reg'; //  apart_url = 'http://192.168.43.75:700/viewPropety';
        //get property API

        this.apart_url = 'https://jsonplaceholder.typicode.com/users';
        this.Aplystutest = 'https://jsonplaceholder.typicode.com/users'; //test api

        this.getstu_url = 'http://168.172.185.106:5000/getstudent';
        this.getstud1_url = 'http://168.172.185.106:5000/getstud/40';
        this.image_url = 'http://168.172.185.106:5000/getimage';
        this.status_url = 'https://jsonplaceholder.typicode.com/posts/2';
        this.proof_url = 'https://jsonplaceholder.typicode.com/users/1';
        this.lordapp_url = 'https://168.172.185.106:5000/lord';
      }
      ...
      _createClass(ServiceService, [{
        ...
        value: function proof() {
          return this.http.get(this.proof_url);
        }
      }, {
        key: "lordprofile",
        value: function lordprofile() {
          return this.http.get(this.proof_url);
        }
      }, {
        key: "lordapp",
        value: function lordapp(lord) {
          return this.http.post(this.lordapp_url, lord, {});
        }
      }, {
        key: "postLogin",
        value: function postLogin(loglord) {
          return this.http.post(this.login_url, loglord, {});
        }
      }, {
        key: "postLandlord",
        value: function postLandlord(addlord) {
          return this.http.post(this.reg_url, addlord, {});
        }
      }, {
        key: "poststu",
        value: function poststu(reg) {
          return this.http.post(this.regstu_url, reg, {});
        }
      }, {
        key: "getApartment",
        value: function getApartment() {
          // return this.http.get<any>(this.apart_url);
          return this.http.get(this.apart_url);
        }
      }, {
        key: "getAppliedstu",
        value: function getAppliedstu() {
          return this.http.get(this.Aplystutest);
        }
      }, {
        key: "getimages",
    ...
    ServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], ServiceService);
    /***/
  }
}]);
