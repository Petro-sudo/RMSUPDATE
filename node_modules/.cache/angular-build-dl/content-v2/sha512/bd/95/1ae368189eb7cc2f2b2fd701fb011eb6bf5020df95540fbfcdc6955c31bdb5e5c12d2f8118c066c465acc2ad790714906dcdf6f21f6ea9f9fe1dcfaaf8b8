...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _userservice_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../userservice.service */ "./src/app/userservice.service.ts");
...
/* harmony import */ var _popover_popemail_popemail_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../popover/popemail/popemail.page */ "./src/app/popover/popemail/popemail.page.ts");
...
let LoginPage = class LoginPage {
    constructor(alertCtrl, router, _serviceService, userserviceService, _loaderservice, popoverController) {
    ...
    loginUser() {
        ...
        this.userserviceService.userLogin(this.loginUserData).subscribe(res => {
            if (res["errorCode"] != 0) {
    ...
    popover(ev) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const popo = yield this.popoverController.create({
...
], LoginPage.prototype, "change", void 0);
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        _service_service__WEBPACK_IMPORTED_MODULE_2__["ServiceService"], _userservice_service__WEBPACK_IMPORTED_MODULE_5__["UserserviceService"],
        _loader_service__WEBPACK_IMPORTED_MODULE_6__["LoaderService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["PopoverController"]])
], LoginPage);
