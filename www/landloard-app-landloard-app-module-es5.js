...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["landloard-app-landloard-app-module"], {
  ...
  function srcAppLandloardAppLandloardAppPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LandloardAppPage(alertCtrl, router, _serviceService, actionSheetCtrl, loadingCtrl) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    if (!(this.lordApply.propName.length == 1 || this.lordApply.add1.length == 1 || this.lordApply.add2.length == 1 || this.lordApply.city.length == 1 || this.lordApply.code.length == 1 || this.lordApply.distance.length == 1 || this.lordApply.feeSharing.length == 1)) {
                      _context2.next = 12;
                      break;
                    }
                  ...
                  case 12:
                    if (!(this.lordApply.docs.length < 2)) {
                      _context2.next = 24;
                      break;
                    }
                  ...
                  case 24:
                    this._serviceService.postLandlord(this.lordApply).subscribe(function (data) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], LandloardAppPage.prototype, "lordApply", void 0);
